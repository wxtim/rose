...
class RoseAnaApp(BuiltinApp):
    ...
    def run(self, app_runner, conf_tree, opts, args, uuid, work_files):
        ...
        # As part of the introduction of a re-written metomi.rose.ana, backwards
        ...
        # of the metomi.rose.ana app (renamed to rose_ana_v1)
        ...
        if not new_style_app:
            ...
            self.reporter("!!WARNING!! - Detected old style metomi.rose.ana app; "
                          "Using previous metomi.rose.ana version...")
        ...
        # Load any metomi.rose.ana specific configuration settings either from the
        ...
        self.titlebar("Launching metomi.rose.ana")
        ...
        self.titlebar("Completed metomi.rose.ana")
    ...
    def _get_global_ana_config(self):
        """Retrieves all metomi.rose.ana config options; these could be from the
        ...
        for keys, node in self.config.walk(no_ignore=True):
            ...
            if task.startswith("ana:"):
                ...
                if len(keys) == 2:
                    ...
                    # The app may define a section containing metomi.rose.ana config
