...
class MacroUpgrade(metomi.rose.macro.MacroBase):
    ...
    def add_setting(self, config, keys, value=None, forced=False,
        ...
        Args:
            ...
            state (str - optional):
                ...
                ``metomi.rose.config.ConfigNode`` states e.g.
                ``metomi.rose.config.ConfigNode.STATE_USER_IGNORED``. Defaults to
    ...
    def ignore_setting(self, config, keys, info=None,
        ...
        Args:
            ...
            info (string - optional): A short string containing no new lines,
                describing the addition of the setting.
            state (string - optional): A ``metomi.rose.config.ConfigNode`` state.
